...
namespace ConsoleApp1
{
    ...
    namespace ConsoleApplication1
    {
        class Program
        {
            ...
            {
                {
                    Console.WriteLine(CoolProp.PropsSI("P", "T", 197.6833, "Q", 1.0, "R717"));
                    Console.WriteLine(CoolProp.PropsSI("P", "T", 197.6833, "Q", 1.0, "R717"));
                    Console.WriteLine(CoolProp.PropsSI("H", "P", 709050, "Q", 0.5, "R410A"));
                    Console.WriteLine(CoolProp.PropsSI("H", "P", 709050, "Q", 0.5, "R410A"));

                    Console.WriteLine(CoolProp.PropsSI("H", "P", 709050, "Q", 0.5, "R22"));
                    Console.WriteLine(CoolProp.PropsSI("H", "P", 709050, "Q", 0.5, "R22"));
                    Console.WriteLine(CoolProp.Props1SI("R32", "molemass"));

                    //Console.WriteLine(CoolProp.PropsSI("P", "T", 273.15, "Q", 0.5, "R410A"));  不适用这样的算法
                    Console.WriteLine(CoolProp.PropsSI("H", "P", 709050, "Q", 0.5, "R410A"));
                }
